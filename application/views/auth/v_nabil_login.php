        ...
        <div class="container d-flex justify-content-center">
            <div class="d-flex flex-column justify-content-between">
                <div class="card mt-3 p-5">
                    ...
                    <a href="<?= base_url('registrasi') ?>" class=" btn btn-primary btn-lg"><span>Registrasi akun<i class="fas fa-long-arrow-alt-right ml-2"></i></span>
                    </a>
                </div>
                <div class="card two bg-white px-5 py-4 mb-3">
                    <form class="user" method="post" action="<?= base_url('login'); ?>">
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg mt-10 mb-2"><span>Login<i class="fas fa-long-arrow-alt-right ml-2"></i></span></button>
                    </form>
                </div>
            </div>
        </div>
